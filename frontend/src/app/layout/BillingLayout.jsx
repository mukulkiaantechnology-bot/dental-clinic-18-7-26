      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 border-b border-border bg-card text-foreground px-4 sm:px-6 flex items-center justify-between z-20">
          <div className="flex items-center gap-3 flex-1">
            ...
            <div className="md:hidden bg-primary text-primary-foreground p-1.5 rounded-lg">
              <Activity className="h-4.5 w-4.5" />
            </div>

            <div className="md:flex items-center gap-1.5 text-xs text-muted-foreground font-semibold hidden pl-2">
              <span>Clinic context:</span>
              <strong className="text-foreground">{user?.clinic?.name || 'Vance Dental HQ'}</strong>
            </div>
          </div>
